            ...
            {filteredDoctors.map((doc) => (
              ...
              >
                <div className="flex items-start gap-3.5 min-w-0 flex-1">
                  <div className="size-11 shrink-0 rounded-full border border-stone-200 bg-stone-100 overflow-hidden flex items-center justify-center shadow-xs">
                    {doc.avatar_url ? (
                      <img src={doc.avatar_url} alt={doc.name} className="size-full object-cover" />
                    ) : (
                      <UserCheck className="size-5 text-[#5b15fc]" />
                    )}
                  </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 pt-1">
                      ...
                      {doc.verification_documents.map((d: any, idx: number) => (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg border border-stone-200 bg-white px-2.5 py-1 text-[11px] font-semibold text-[#5b15fc] hover:bg-[#5b15fc]/5 shadow-xs transition-all"
                        >
                ...
                <div className="flex items-center gap-2 shrink-0 pt-2 lg:pt-0">
                  {doc.verification_status === "PENDING" ? (
                    ...
                    <button
                      ...
                      className={`rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-all cursor-pointer shadow-xs ${
                        doc.is_active
